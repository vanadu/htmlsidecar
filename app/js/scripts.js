...
var Witty = (function () {
  ...
  var UIController = (function() {
    ...
    const ccpUserInput = {
      ...
      chkCcpImgIncludeAnchorCheckbox: '#chk-ccp-img-include-anchor-checkbox',
    ...
    // !VA Parent elements of elements to be displayed/undisplayed with active class based on tdoptions selections
    const ccpParentElement = {
      ccpTdAlign: '#ccp-td-align', 
      ccpTdValign: '#ccp-td-valign', 
      ccpTdClass: '#ccp-td-class', 
      ccpTdHeight: '#ccp-td-height', 
      ccpTdWidth: '#ccp-td-width', 
      ccpTdBgColor: '#ccp-td-bgcolor', 
      ccpTdFontColor: '#ccp-td-fontcolor', 
      ccpTdBorderColor: '#ccp-td-bordercolor',
      ccpTdBorderRadius: '#ccp-td-borderradius', 
      ccpTableWrapperClass: '#ccp-table-wrapper-class', 
      ccpTableWrapperWidth: '#ccp-table-wrapper-width', 
      ccpTableWrapperAlign: '#ccp-table-wrapper-align', 
      ccpTableWrapperBgColor: '#ccp-table-wrapper-bgcolor'
    };
    ...
    return {
      ...
      populateAppobj: function (Appobj, access) {
        ...
        function populateCcpProperties(Appobj) {
          ...
          var foo = document.querySelector(ccpUserInput.chkCcpImgIncludeAnchorCheckbox).value;
          console.log('foo is: ' + foo);
  ...
  var CBController = (function() {
    ...
    function getAttributes() {
      ...
      Attributes = {
        ...
        imgIncludeAnchor: (function() {
          ...
          ccpElementId = false;
          let target, checked;
          target = ccpUserInput.chkCcpImgIncludeAnchorCheckbox;
    ...
    function getUserSelections( id ) {
      ...
      uSels = {
        buttonClicked: '',
        hasAnchor: getCheckboxSelection(ccpUserInput.chkCcpImgIncludeAnchorCheckbox),
    ...
    function makePosSwitchNodes( id, Attributes ) {
      ...
      var target = ccpUserInput.chkCcpImgIncludeAnchorCheckbox;
...
style="background-color:#556270;background-image:url(${Attributes.imgSrc.str});border:1px solid #1e3650;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:${tdHeight}px;text-align:center;text-decoration:none;width:${tdWidth}px;-webkit-text-size-adjust:none;mso-hide:all;">Show me the button!</a></div>`;
  ...
  var appController = (function(CBCtrl, UICtrl) {
    ...
    var setupEventListeners = function() {
      ...
      let includeAnchorCheckbox = document.querySelector('#ccp-img-include-anchor-label');
    ...
    */
    ...
    function handleImgType3(imgType) {
    ...
    function toggleIncludeAnchor(evt) {
      ...
      checkbox = document.querySelector(ccpUserInput.chkCcpImgIncludeAnchorCheckbox);
      // checkbox.checked === true ? checkbox.checked = true : checkbox.checked = false;
      // !VA For some reason I don't understand, the checked attribute of the checkbox is actually the opposite of the visual state of the checkbox, so swap the true and false assignment.
      checkbox.checked  ? Appobj.chkCcpImgIncludeAnchorCheckbox = 'off' : Appobj.chkCcpImgIncludeAnchorCheckbox = 'on';
      console.log('Appobj: ');
      console.dir(Appobj);
    ...
    function toggleIncludeWrapper(option) {
      ...
      //   checkbox.checked ? checkbox.checked = false : checkbox.checked = true;
      //   checkbox.checked ? UIController.handleCcpActions3(Appobj, wrapperItems, true) : UIController.handleCcpActions( 'setactiveparent', wrapperItems, false);
      // } else if (option === true ) {
